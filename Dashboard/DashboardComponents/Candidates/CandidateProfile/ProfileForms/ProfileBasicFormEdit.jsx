    ...
    <div className=" md:p-5 p-5 " >
      <div className="">
        ...
        <div className=" bg- border">
          <form onSubmit={handleUpdate} className="bg-white  p-5">
                ...
                <div className="w-full flex-col">
                  <div className="w-full">
                    ...
                    <input type="file"
                      ...
                      onChange={(e) => { setFile1(e.target.files[0]), Validators(e.target.files[0]) }} multiple={false} />
                  </div>
                </div>
                <div className="w-full flex-col">
                  <div className="w-full">
                    ...
                    <input
                      type="file"
                      className="h-9 outline-none focus:right-0 right-0 rounded-lg w-full border"
                      onChange={(e) => { setcvAttachment(e.target.files[0]), fileValdate(e.target.files[0]) }}
